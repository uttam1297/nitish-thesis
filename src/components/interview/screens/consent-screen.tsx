...
export function ConsentScreen() {
  ...
  return (
    <Surface className="mx-auto flex max-h-[calc(100dvh-8rem)] w-full max-w-(--width-interview) flex-col overflow-hidden border-none p-0 shadow-none">
      <div className="flex min-h-0 flex-1 flex-col gap-4 overflow-y-auto px-6 py-6 sm:px-10 sm:py-8">
        <div className="mx-auto flex w-full max-w-(--width-reading) flex-col gap-4">
      ...
      <div className="shrink-0 border-t px-6 py-4 sm:px-10">
        <div className="mx-auto w-full max-w-(--width-reading)">
          <NavigationControls
