import { buildCoreQuestions } from "@/config/interview/core-questions";
 ...
 */
export const QUESTIONNAIRE_VERSION = "1.4.0";
...
function buildQuestionnaire(
  ...
  return questionnaireSchema.parse({
    ...
    sections,
    constructs,
    questions: [...profileQuestions, ...buildCoreQuestions(allowNotApplicable)],
  });
}
 ...
 */
export const questionnaireV130 = buildQuestionnaire("1.3.0", false);
export const questionnaireV140 = buildQuestionnaire("1.4.0", true);
export const questionnaire = questionnaireV140;

const questionnairesByVersion = new Map(
  [questionnaireV130, questionnaireV140].map((item) => [item.version, item])
);
